...
--     vim.g.gruvbox_material_transparent_background_level = 1
--     vim.g.gruvbox_material_italics = false
--     vim.g.gruvbox_material_disable_italic_comments = false
...
--     vim.g.gruvbox_material_on_highlights = function(highlight_groups, palette) end
